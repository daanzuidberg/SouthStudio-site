      ...
      <div style={{ padding: '0 60px' }}>
        ...
        <FSection no="06" title="The mark & the system">
          <div style={{ display: 'grid', gridTemplateColumns: '170px 1fr', gap: 30, alignItems: 'start' }}>
            ...
            <div>
              <p style={{ ...body, marginBottom: 18 }}>The mark is a logic grid — one red cell, two black, the rest open. It is literally the thing we make. Use it as the studio signature on everything, small and quiet. Never redraw it.
